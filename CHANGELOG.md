...
- Salvaged remaining beneficial pickups only after the battlefield is genuinely clear, preventing fresh final-kill rewards from being erased by the locked stage-clear cleanup.
- Kept salvaged Enigma signals mandatory: their normal slowdown and accessible three-card choice resolve before hyperspace can begin.
