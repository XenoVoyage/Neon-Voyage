...
Procedural gameplay art shares a layered material language: deep readable masses, restrained colored rims, pale structural highlights, and small emissive cores. The first pilot applies that language to the player ship, a representative alien scout and shared alien hull foundation, rocky asteroid facets, player and hostile projectiles, pickups, and impact particles. Their established silhouettes and role colors remain the gameplay contract; later full-family passes should extend this foundation only after the pilot is reviewed in motion against the authored worlds.
