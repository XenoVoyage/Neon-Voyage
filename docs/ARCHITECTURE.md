...
| `js/audio.js` | Optional material/weapon-specific synthesized cues, master gain, cooldowns, and active-node cap | Gameplay decisions or preference storage |
