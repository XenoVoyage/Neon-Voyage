...
- Release coverage must include the rendered browser smoke, a weapon-driven Stage 1–20 journey through both bosses, the long deterministic stress run, entity caps, storage failure, responsive layouts, and input cleanup.
