...
| --- | --- |
| `config-core.test.js` | Immutable twenty-stage configuration and bounded audio mix/limiter values, stage-clear/touch-hold/game-over presentation timing, early alien contact, Stage 5 Titan structure, durable alien contacts and child ceilings, three-boss cadence, five reward bands, gated powerups/modules, ten milestones, crystal shrapnel, 13 Mk V systems, deterministic math, storage, bounds, and caps |
...
| `progress.test.js` | Strict schema-5 validation, exact schema-4 seven-to-twenty expansion, one-to-one schema-3/schema-2 and exact schema-1 migration, compatible/persistent volume and impact-feedback preferences, twenty Mk V/stacked checkpoints, ten milestone rewards, loadout summaries, dialogs, focus, and stage selection |
...
| `gameplay.test.js` | Finite balanced waves and pressure-bounded reserves, clean-field pickup/Enigma salvage, expanded field containment and bounded camera follow, locked clear/travel handoff, terminal-but-delayed game-over presentation, Pulse asteroid pull without alien displacement, finite crystal shrapnel, slow inherited Auric fragmentation and Corona hazards, Gunship/Brood state, gated rewards, eight stacking effects including Thruster Surge, passive ranges, shared boss geometry/reflection, bounded Sovereign radial barrages, and the complete Stage 1–20 journey |
| `visuals.test.js` | Shell-owned renderer sizing, pointer-only reticle, capped clustered off-screen objective cues, terminal ship suppression, opt-in shake/flash rendering, twenty-scene continuity, exact gameplay-raster mapping/draw coverage, readable alien and Sovereign play sizes and damage states, raster-led overlay contracts including stripe-free Overdrive art, deterministic irregular asteroid fractures, semantic pickup identities, player hull damage states, cached late/boss washes, Enigma micro-previews, cinematic contracts, and compact responsive rules |
| `stress.test.js` | Long deterministic full-build simulation, crystal shrapnel, hazard and reflection phase exercise, complete twenty-stage, three-boss, and alien-role coverage, reproducibility, finite state, all passive systems, and enforced caps |
...
| Campaign and bosses | Complete Stage 1–20; confirm Stage 3 first contact, the Stage 5 Titan, Harrower at Stage 10, Leviathan at Stage 15, and giant five-node Sovereign at Stage 20; verify balanced groups, bounded descendants, expanded finite fields, node-dependent reflection, Sovereign radial/mine/beam phases, touch auto-aim priority, clean escorts, and bounded next-sector wrap |
| Rewards and persistence | Exercise all five drop bands (44/48/52/56/60%, pity 3/2/2/2/2), stage-gated pickup/module catalogs, Mk I–V ceilings, all ten milestone modules, all 13 modules, all eight four-stack timers, twenty Continue cards, exact schema-4 seven-to-twenty expansion, one-to-one schema-3/schema-2 migration, schema-1 migration, malformed/denied/oversized storage, checkpoint refresh, and confirmed New Game reset |
