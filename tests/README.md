...
| `visuals.test.js` | Shell-owned renderer sizing, pointer-only reticle, twenty-scene continuity, exact complete gameplay-raster mapping and draw coverage, cached late/boss washes, deterministic Enigma micro-previews, clear-versus-travel hyperspace contracts, projectile/field contracts, damage presentation, and compact responsive summary/dialog rules |
